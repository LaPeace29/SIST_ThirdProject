	    	 ...
	    	 var exam_id = $(this).parents("tr").find("td:eq(0)").text();
	   			$.ajax({
	   				...
	   				,success: function(data_) {
   						...
   						txt+="<div class=\"card\" id=\"card\">";
   						txt+="<div class=\"card-header d-flex align-items-center\">";
   						txt+="<h3 class=\"h4\">수강생 정보</h3>";
   						txt+="</div>";
						...
						txt+="		<tbody>";
	   					...
	   					for(var a=0; a<doc.length; ++a) {
                            ...
                            +"</td><td>"+temp.attendance_score+"</td><td>"+temp.write_score+"</td><td>"+temp.skill_score+"</td><td>"+temp.total_score+"</td><td>"+
	   						"<div class=\"btn-group\"><button class=\" btn btn-light btn-sm btn-look1\"data-toggle=\"modal\" data-target=\"#score_reg\" value="temp.student_id">입력</button><button class=\"btn btn-sm btn-light btn-del\"data-toggle=\"modal\" data-target=\"#subjectbook_delete\">삭제</button></div></td></tr>";
	   					}
						txt +="		</tbody>";
   						txt += "	</table>";
						txt += "	</div>";
						...
						$(".btn-look1").on(
								...
								function() {
									...
									$("#score_reg #student_id").val(
											$(this).val());
									$("#score_reg #student_name").html(temp);
			...
			<div class="content-inner">
				...
				<div class="breadcrumb-holder container-fluid">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="instructor_score1.jsp">성적
								관리</a></li>
						<li class="breadcrumb-item active"><a
							href="instructor_score2.jsp">시험 정보</a></li>
					</ul>
				</div>
                                          ...
                                          <td><button class="btn btn-sm btn-light btn-student ">보기</button></td>
													...
													<c:forEach var="e" items="${list}">
														...
														<tr>
															...
															<td><button
																	class="btn btn-sm btn-light btn-student ">보기</button></td>
	...
	<div id="score_reg" role="dialog" class="modal fade text-left">
		<div role="document" class="modal-dialog">
			<div class="modal-content">
				...
				<p id="student_name">조인성 / 010-1234-1234</p>
				<div class="modal-body">
					<form
						action="${pageContext.request.contextPath}/instructor/score2/insert"
						method="post">
						<div class="form-group">
							<label for="subjectbook_name">출석 점수</label> <input type="text"
								id="attendance_score" name="attendance_score"
								placeholder="출석 점수" class="form-control">
						</div>
						<div class="form-group">
