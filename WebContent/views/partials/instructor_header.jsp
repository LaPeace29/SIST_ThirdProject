		...
		<div class="container-fluid">
			<div
				...
				<div class="navbar-header">
					<!-- Navbar Brand -->
					<a href="${pageContext.request.contextPath}/views/instructor/09_instructor_first.jsp" class="navbar-brand d-none d-sm-inline-block">
				...
				<ul
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							<li><a rel="nofollow" href="${pageContext.request.contextPath}/views/instructor/instructor_info.jsp" class="dropdown-item"> 개인정보 확인</a></li>
							<li><a rel="nofollow" href="${pageContext.request.contextPath}/views/instructor/instructor_changepw.jsp" class="dropdown-item"> 비밀번호 변경</a></li>
