	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".instructor_manage").on("click", function(){
				window.location.assign("${pageContext.request.contextPath}/views/admin/admin_instructor_mng2.jsp");
			});
		});
										...
										<div class="table-responsive">
											<table class="table">
												...
												<tbody>
		                                            <tr>
		                                                <td>INS001</td>
		                                                <td><a class="instructor-look popover-bold" data-toggle="popover" title="김강사 사진" data-content="<img src='${pageContext.request.contextPath}/resources/img/avatar-1.jpg' width='120' height='144'/>">김강사</a></td>
		                                                <td>010-1234-4321</td>
		                                                <td>2018-01-02</td>
														...
														<td><button class="btn btn-sm btn-light btn-del"
																data-toggle="modal" data-target="#instructor_delete">삭제</button></td>
														<td><button class="btn btn-sm btn-light btn-reset"
																data-toggle="modal" data-target="#password_reset">초기화</button></td>
													</tr>
		                                            <tr>
		                                                <td>INS002</td>
		                                                <td><a class="instructor-look popover-bold" data-toggle="popover" title="이강사 사진" data-content="<img src='${pageContext.request.contextPath}/resources/img/avatar-1.jpg' width='120' height='144'/>">이강사</a></td>
		                                                <td>010-4444-4321</td>
		                                                <td>2018-05-05</td>
		                                            ...
		                                            <tr>
		                                                <td>INS003</td>
		                                                <td><a class="instructor-look popover-bold" data-toggle="popover" title="홍강사 사진" data-content="<img src='${pageContext.request.contextPath}/resources/img/avatar-1.jpg' width='120' height='144'/>">홍강사</a></td>
		                                                <td>010-1111-4321</td>
		                                                <td>2018-05-05</td>
